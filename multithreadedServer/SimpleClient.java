...
public class SimpleClient {
    Socket socket ;       //Socket object for communicating
    PrintWriter out ;    //socket output to server - for sending data through the socket to the server
    BufferedReader in ;  //socket input from server - for reading server's response
    public SimpleClient ()
	    {
	    	this.socket=null;
	    	this.out=null;
